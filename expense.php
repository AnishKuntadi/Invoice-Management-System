<?php
  ...
  {  
        ...
        if($data->insert('expense', $insert_invoice))  
        {  
  ...
  {  
      ...
      if($data->delete("expense", $where))  
      {  
           header("location:expense.php?deleted=1");  
      }  
  }
        ...
        <div class="modal-dialog modal-lg">
          ...
          <div class="modal-content">
            <div class="modal-header">
              <h3 class="modal-title">Expense Invoices</h3>
...
<div class="table-responsive">  
  <table id="expenseData" class="table table-striped table-bordered">
  <thead>  
    <tr> 
      <th width="12%">Expense Types</th>
  ...
  <?php  
    ...
    ?>  
    <tr>
    <td><?php echo $post["expense_types"]; ?></td>  
      ...
      <td class="text-right">
        <div class="dropdown ">
          ...
          <div class="dropdown-menu dropdown-menu-right">
            <a  href="test_expense.php?edit=1&id=<?php echo $post["id"]; ?>">Edit</a><br>
            <a href="#" id="<?php echo $post["id"]; ?>" class="deleteExpense">Delete</a><br>
          </div>
        </div>
      </td>
      </tr>  
